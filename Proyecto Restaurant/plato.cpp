...
void Plato::mostrarEntrada(){
    ...
    cout << "--------------\n";
    cout << "NUESTRAS ENTRADAS\n";

    while(fread(&plato, sizeof (Plato), 1, p)){
    if(plato.estado == 1 && plato.tipoPlato == 1 ){
    cout << "--------------\n";
    plato.mostrar();
    }
    }
...
void Plato::mostrarPrincipal(){
    ...
    cout << "--------------\n";
    cout << "NUESTROS PLATOS PRINCIPALES\n";

    while(fread(&plato, sizeof (Plato), 1, p)){
    if(plato.estado == 1 && plato.tipoPlato == 2){
    cout << "--------------\n";
    plato.mostrar();
    }
    }
...
void Plato::mostrarGuarnicion(){
    ...
    cout << "--------------\n";
    cout << "NUESTRAS GUARNICIONES\n";

    while(fread(&plato, sizeof (Plato), 1, p)){
    if(plato.estado == 1 && plato.tipoPlato == 3 ){
    cout << "--------------\n";
    plato.mostrar();
    }
    }
...
void Plato::mostrarPostre(){
    ...
    cout << "--------------\n";
    cout << "NUESTROS POSTRES\n";

    while(fread(&plato, sizeof (Plato), 1, p)){
    if(plato.estado == 1 && plato.tipoPlato == 4 ){
    cout << "--------------\n";
    plato.mostrar();
    }
    }
